...
class Sunset extends StatelessWidget {
  // IDs das camas (6 camas)
  final List<String> bedIds = ['bed1', 'bed2', 'bed3', 'bed4', 'bed5', 'bed6'];

  // Rótulos abreviados dos tipos de roupa de cama
  ...
  // Referência ao documento da cama em rooms/sunset/beds/{bedId}
  ...
  // Sub-coleção de logs de cada cama
                                    ...
                                    onPressed: () async {
                                      try {
                                        ...
                                        ScaffoldMessenger.of(context)
                                            .showSnackBar(
                                          SnackBar(content: Text('Alt $label')),
                                        );
                                      } catch (err) {
                                        ScaffoldMessenger.of(context)
                                            .showSnackBar(
